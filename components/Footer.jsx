    ...
    <footer className="mt-8 border-t border-[hsl(var(--border))] bg-[hsl(var(--surface))] py-14 text-[hsl(var(--foreground))]">
      <div className="container mx-auto px-4">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            <h4 className="mb-3 text-sm font-semibold uppercase tracking-[0.18em] text-[hsl(var(--warm-gray-dark))]">{siteContent.footer.navTitle}</h4>
          ...
          <div>
            <h4 className="mb-3 text-sm font-semibold uppercase tracking-[0.18em] text-[hsl(var(--warm-gray-dark))]">{siteContent.footer.contactTitle}</h4>
        ...
        <div className="mt-12 border-t border-[hsl(var(--border))] pt-6 text-center">
          <p className="text-xs text-[hsl(var(--muted-foreground))]">© {new Date().getFullYear()} {siteConfig.brandName}. {siteContent.footer.rights}</p>
        </div>
      </div>
    </footer>
  )
